$(document).ready(function () {
    $("#site #container #main-content-wp #wrapper .section-detail .table input#qty").change(function(){
        ...
        $.ajax({
            ...
            success:function(data){
                $(this).val(data.qty);
                $("#site #container #main-content-wp #wrapper .section-detail .table td p#sub_total_"+data.rowId).text(data.sub_total)
                $("#site #container #main-content-wp #wrapper .section-detail .table span#total").text(data.total)
    ...
    $("#site #container #main-content-wp #wrapper .section-detail form div#provinces select").change(function(){
        ...
        $.ajax({
            ...
            'url':'checkout/ajax/district',
            'method':'post',
            'data':data,
            success:function(data){
                $("#site #container #main-content-wp #wrapper .section-detail form div#districts select").html(data)
            },
            error:function(xhr,ajaxOptions,thrownError)
            {
                alert(xhr.status);
    ...
    $("#site #container #main-content-wp #wrapper .section-detail form div#districts select").change(function(){
        ...
        $.ajax({
            ...
            'url':'checkout/ajax/ward',
            'method':'post',
            'data':data,
            success:function(data){
                $("#site #container #main-content-wp #wrapper .section-detail form div#wards select").html(data)
            },
            error:function(xhr,ajaxOptions,thrownError)
            {
                alert(xhr.status);
