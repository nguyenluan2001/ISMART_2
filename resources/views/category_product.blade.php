        ...
        <div class="secion" id="breadcrumb-wp">
            <div class="secion-detail">
                <ul class="list-item clearfix">
                    ...
                    <li>
                        <a href="" title="">{{$product_sub_cat->product_cat->product_cat_title}}</a>
                    </li>
                    <li>
                        <a href="" title="">{{$product_sub_cat->product_sub_cat_title}}</a>
                    </li>
                </ul>
            </div>
        </div>
        <div class="main-content fl-right">
            <div class="section" id="list-product-wp">
                <div class="section-head clearfix">
                    <h3 class="section-title fl-left">{{$product_sub_cat->product_sub_cat_title}}</h3>
                    @php 
                    $product_sub_cat_slug=$product_sub_cat->slug ;
                    $product_cat_slug=$product_sub_cat->product_cat->slug;
                     @endphp
                    <div class="filter-wp fl-right">
                        <p class="desc">Hiển thị 45 trên 50 sản phẩm</p>
                        <div class="form-filter">
                            <form method="GET" action="{{route('product.category.filter',[$product_cat_slug,$product_sub_cat_slug])}}">
                                @csrf
                                <select name="filter">
                ...
                <div class="section-detail">
                    <ul class="list-item clearfix">
                        ...
                        <li>
                            <a href="{{route('product.show',$item->slug)}}" title="" class="thumb">
