        ...
        <div class="main-content fl-right">
            <div class="section" id="slider-wp">
                <div class="section-detail">
                    <div class="item">
                        <img src="public/main/images/slider-01.png" alt="">
                    </div>
                    <div class="item">
                        <img src="public/main/images/slider-02.png" alt="">
                    </div>
                    <div class="item">
                        <img src="public/main/images/slider-03.png" alt="">
                    </div>
                </div>
            </div>
            <div class="section" id="support-wp">
                <div class="section-detail">
                    <ul class="list-item clearfix">
                        <li>
                            <div class="thumb">
                                <img src="public/main/images/icon-1.png">
                            </div>
                        ...
                        <li>
                            <div class="thumb">
                                <img src="public/main/images/icon-2.png">
                            </div>
                        ...
                        <li>
                            <div class="thumb">
                                <img src="public/main/images/icon-3.png">
                            </div>
                        ...
                        <li>
                            <div class="thumb">
                                <img src="public/main/images/icon-4.png">
                            </div>
                        ...
                        <li>
                            <div class="thumb">
                                <img src="public/main/images/icon-5.png">
                            </div>
                    ...
                    <ul class="list-item">
                        <li>
                            <a href="?page=detail_product" title="" class="thumb">
                                <img src="public/main/images/img-pro-05.png">
                            </a>
                        ...
                        <li>
                            <a href="?page=detail_product" title="" class="thumb">
                                <img src="public/main/images/img-pro-08.png">
                            </a>
                        ...
                        <li>
                            <a href="?page=detail_product" title="" class="thumb">
                                <img src="public/main/images/img-pro-07.png">
                            </a>
                        ...
                        <li>
                            <a href="?page=detail_product" title="" class="thumb">
                                <img src="public/main/images/img-pro-10.png">
                            </a>
                        ...
                        <li>
                            <a href="?page=detail_product" title="" class="thumb">
                                <img src="public/main/images/img-pro-06.png">
                            </a>
                        ...
                        <li>
                            <a href="?page=detail_product" title="" class="thumb">
                                <img src="public/main/images/img-pro-09.png">
                            </a>
            ...
            <div class="section" id="list-product-wp">
                ...
                <div class="section-head">
                    <h3 class="section-title">{{$item->product_sub_cat_title}}</h3>
                </div>
                <div class="section-detail">
                    <ul class="list-item clearfix">
                        @foreach($item->products as $value)
                        <li>
                            <a href="{{route('product.show',$value->slug)}}" title="" class="thumb">
                                <img src="{{asset('public/uploads/products/'.$value->product_img)}}">
                            </a>
                            <a href="{{route('product.show',$value->slug)}}" title="" class="product-name">{{$value->product_name}}</a>
                            <div class="price">
            ...
            <div class="section" id="category-product-wp">
                ...
                <div class="secion-detail">
                    <ul class="list-item">
                        ...
                        <li>
                            <a href="" title="">{{$item->product_cat_title}}</a>
                            <ul class="sub-menu">
            ...
            <div class="section" id="banner-wp">
                <div class="section-detail">
                    <a href="" title="" class="thumb">
                        <img src="public/main/images/banner.png" alt="">
                    </a>
                </div>
            </div>
        </div>
