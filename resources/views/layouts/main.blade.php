...
<head>
    ...
    <meta charset="UTF-8">
    <base href="http://localhost:8080/UNITOP.VN/BACK-END/LARAVELPRO/MyShop/">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <link href="public/main/css/bootstrap/bootstrap-theme.min.css" rel="stylesheet" type="text/css" />
    <!-- <link href="public/main/css/bootstrap/bootstrap.min.css" rel="stylesheet" type="text/css" /> -->
    <link href="public/main/reset.css" rel="stylesheet" type="text/css" />
    <link href="public/main/css/carousel/owl.carousel.css" rel="stylesheet" type="text/css" />
    <link href="public/main/css/carousel/owl.theme.css" rel="stylesheet" type="text/css" />
    <link href="public/main/css/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
    <link href="public/main/style.css" rel="stylesheet" type="text/css" />
    <link href="public/main/responsive.css" rel="stylesheet" type="text/css" />

    <script src="public/main/js/jquery-2.2.4.min.js" type="text/javascript"></script>
    <script src="public/main/js/elevatezoom-master/jquery.elevatezoom.js" type="text/javascript"></script>
...
<body>
    <div id="site">
                ...
                <div id="foot-body">
                    <div class="wp-inner clearfix">
                        <div class="block" id="info-company">
                            ...
                            <div id="payment">
                                <div class="thumb">
                                    <img src="public/main/images/img-foot.png" alt="">
                                </div>
                            </div>
                        </div>
        ...
        <div id="btn-top"><img src="public/main/images/icon-to-top.png" alt="" /></div>
        <div id="fb-root"></div>
        <script>
            (function(d, s, id) {
