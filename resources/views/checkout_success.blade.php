...
<div id="main-content-wp" class="pay-success clearfix text-center">
    <div class="wp-inner mx-auto">
        <img style="width: 100px;" class="mx-auto" src="{{url('public/main/images/icon-tick-v.png')}}" alt="">
        ...
        <div id="order_info" class="w-50 mx-auto mb-4">
            ...
            <div class="info d-flex border border-top-0" >
                ...
                <div class="w-50">
                    <p class="font-weight-bold">{{$order['more_info']['code']}}</p>
                    @if($order['more_info']['payment']=='payment-home')
                    <p class="font-weight-bold">Thanh toán tại nhà</p>
                    @else
                    <p class="font-weight-bold">Thanh toán tại cửa hàng</p>
                    @endif
                    <p class="font-weight-bold">{{$order['more_info']['customer_name']}}</p>
                    <p class="font-weight-bold">{{$order['more_info']['phone']}}</p>
        ...
        <a href="{{route('index')}}" class="btn btn-outline-success">Mua tiếp</a>
